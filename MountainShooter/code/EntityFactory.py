...
from code.Const import WIN_WIDTH, IMAGE_MENU, WIN_HEIGHT
...
class EntityFactory:
    ...
    def get_entity(entity_name: str, position=(0, 0)):
        match entity_name:
            ...
            case 'Enemy1':
                return Enemy(name='Enemy1', position=(WIN_WIDTH + 10, random.randint(0 + 40, WIN_HEIGHT - 40)))

            case 'Enemy2':
                return Enemy(name='Enemy2', position=(WIN_WIDTH + 10, random.randint(0 + 40, WIN_HEIGHT - 40)))
